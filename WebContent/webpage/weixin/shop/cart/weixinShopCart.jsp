    ...
    <div id="scnhtm5" class="m-body">
        <div class="m-detail-mainout">
            ...
            <ul class="m-cart-list">
            	<c:forEach items="${ShopCarList}" var="mallcar">
            		 <li number="${mallcar.count}" goodsId="${mallcar.shopGoodsEntity.id}">
	                    ...
	                    <span class="con">
	                        <a href="weixinShopController.do?goPage&page=goodsdetail&goodsid=${mallcar.shopGoodsEntity.id}" class="t">${mallcar.shopGoodsEntity.title}</a>
                        ...
                        <p>
                            <label>价格：</label>
                            <span class="price">￥${mallcar.total}</span>
            ...
            <div class="m-cart-toal">
                ...
                <p class="act">
                    <a href="weixinShopController.do?goPage&page=index&accountid=${accountid}" class="back">继续购物<i></i>
                    </a>
...
<script type="text/javascript">
	...
	function jumpConfirm(){
		...
		if(liArray.length==0){
			alert("购物车没有商品，暂时无法结算！");
			return;
		}
		
	    location.href="weixinShopDealController.do?goConformOrder&shopSymbol=shop";
	}
