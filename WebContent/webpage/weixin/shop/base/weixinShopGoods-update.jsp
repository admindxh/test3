...
<html>
 <head>
  ...
  $(function () {
      ...
      //编辑时初始化图片预览
      var name = "${weixinShopGoodsPage.title}", imageHref = "${weixinShopGoodsPage.titleImg}";
      if(name != ""){
 ...
 <div class="media_preview_area">
		...
		<table style="width: 90%" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="title" name="title" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinShopGoodsPage.title}'>
					...
					<td class="value">
					     	...
					     	<input id="titleImg" name="titleImg" value="${weixinShopGoodsPage.titleImg }" type="hidden" style="width: 150px" class="inputxt">
						...
						<td class="value">
						     	 <input id="price" name="price" type="text" style="width: 150px" class="inputxt" datatype="d" errormsg="商品原价格式不正确!"   value='${weixinShopGoodsPage.price}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="realPrice" name="realPrice" type="text" style="width: 150px" class="inputxt"  onchange="calucatesale(this.value)" datatype="d" errormsg="商品现价格式不正确!"   value='${weixinShopGoodsPage.realPrice}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="sale" name="sale" type="text" style="width: 150px" class="inputxt"  onchange="calucatereal(this.value)"   datatype="d" errormsg="商品折扣格式不正确!" value='${weixinShopGoodsPage.sale}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="expressName" name="expressName" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinShopGoodsPage.expressName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="expressPrice" name="expressPrice" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinShopGoodsPage.expressPrice}'>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <textarea id="descriptions" name="descriptions" style="width: 600px;height:300px">${weixinShopGoodsPage.descriptions}</textarea>
							<script type="text/javascript">
